...
import { Info, Globe, ChevronDown, Check, Lock } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ mode, setMode, onReset, onShowOnboarding, lang, setLang, hasFiles, hasHistory }) => {
  ...
  return (
    <>
      ...
      {showSecurityModal && <SecurityModal onClose={() => setShowSecurityModal(false)} lang={lang} />}
    </>
  );
};
